...
public class PanDulce extends javax.swing.JFrame {
     ...
     PanDulce(Menu aThis, boolean rootPaneCheckingEnabled) {
     ...
     private void initComponents() {
          ...
          jLabel1.setText("Conchas");
          jLabel1.setToolTipText("");
          jLabel1.setBorder(javax.swing.BorderFactory.createMatteBorder(3, 3, 3, 3, new java.awt.Color(201, 151, 58)));

          jLabel3.setForeground(new java.awt.Color(255, 255, 255));
          jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/pan tuniado.jpg"))); // NOI18N
          jLabel3.setBorder(javax.swing.BorderFactory.createMatteBorder(10, 10, 10, 10, new java.awt.Color(201, 151, 58)));

          jLabel2.setBackground(new java.awt.Color(201, 151, 58));
          jLabel2.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
          jLabel2.setForeground(new java.awt.Color(255, 255, 255));
          jLabel2.setText("<html>La concha es una variedad de pan de dulce mexicano. <br>Es llamada así por su semejanza con una concha de mar. <br>Contiene una capa hecha a base de azúcar, manteca y <br>harina en la parte superior, la cual generalmente es blanca o café.</html>");
